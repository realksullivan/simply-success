...
const TESTIMONIALS = [
  {
    quote: 'I\'ve tried every productivity app out there. Simply Success is the first one that actually changed my behavior.',
    name: 'James R.',
    ...
    <div style={{ background: '#08101E', minHeight: '100vh', fontFamily: "'DM Sans', sans-serif", color: '#F4F0E8', overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 700, color: '#F4F0E8', lineHeight: 1.2 }}>Simply</div>
            <div style={{ fontSize: 10, color: '#C8922A', letterSpacing: '0.15em', textTransform: 'uppercase', lineHeight: 1.2 }}>Success</div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          <button
            ...
            style={{
              ...
              color: '#7A91B0', padding: '8px 18px', borderRadius: 8,
          ...
          <button
            onClick={() => navigate('/login')}
            className="gold-btn pulse-gold"
            style={{
              background: 'linear-gradient(135deg, #C8922A, #A87020)',
              border: 'none', color: 'black', fontWeight: 700,
      ...
      <section style={{ padding: '100px 40px 80px', textAlign: 'center', position: 'relative' }}>
        ...
        <div className="fade-in" style={{ marginBottom: 16 }}>
          <span style={{
            ...
            color: '#C8922A', fontSize: 11, fontWeight: 600,
        ...
        <h1 className="fade-in delay-1" style={{
          ...
          Stop Losing Days.
          <br />
          <span style={{ color: '#C8922A', fontStyle: 'italic' }}>Start Winning Them.</span>
        </h1>

        <p className="fade-in delay-2" style={{
          fontSize: 18, color: '#7A91B0', lineHeight: 1.7,
          maxWidth: 520, margin: '0 auto 48px',
          fontWeight: 400,
        }}>
          Simply Success is the daily operating system for high performers.
        ...
        <div className="fade-in delay-3" style={{ display: 'flex', gap: 16, justifyContent: 'center', marginBottom: 64, flexWrap: 'wrap' }}>
          ...
          <button
            ...
            style={{
              background: 'transparent', border: '1px solid #1E3550',
              color: '#7A91B0', padding: '14px 32px', borderRadius: 10,
              fontSize: 15, cursor: 'pointer', fontFamily: 'inherit',
            }}
        ...
        {/* App Preview Card */}
        <div className="fade-in delay-4 float" style={{
          maxWidth: 760, margin: '0 auto',
          background: '#0D1929', border: '1px solid #1E3550',
          borderRadius: 16, overflow: 'hidden',
          boxShadow: '0 40px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(200,146,42,0.1)',
        }}>
          {/* Mock browser bar */}
          <div style={{
            background: '#0A1525', borderBottom: '1px solid #1E3550',
            ...
            <div style={{
              flex: 1, marginLeft: 8, background: '#132035',
              borderRadius: 4, padding: '3px 12px',
              fontSize: 11, color: '#3A5070', textAlign: 'left',
            }}>
              simply-success.vercel.app
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '180px 1fr', minHeight: 360 }}>
            ...
            <div style={{ borderRight: '1px solid #1E3550', padding: '20px 12px' }}>
              ...
              {[
                ...
                <div key={n.label} style={{
                  ...
                  background: n.active ? 'rgba(200,146,42,0.1)' : 'transparent',
                  borderLeft: n.active ? '2px solid #C8922A' : '2px solid transparent',
                }}>
            ...
            <div style={{ padding: 20 }}>
              ...
              {/* Won the day */}
              <div style={{
                background: 'rgba(26,138,90,0.1)', border: '1px solid rgba(26,138,90,0.3)',
      ...
      <section className="fade-in" style={{
        borderTop: '1px solid #1E3550', borderBottom: '1px solid #1E3550',
        padding: '32px 40px',
        ...
        {[
          ...
          { value: '90 days', label: 'To change your life' },
        ].map(s => (
      ...
      <section id="how-it-works" style={{ padding: '100px 40px', maxWidth: 1000, margin: '0 auto' }}>
        <div className="fade-in" style={{ textAlign: 'center', marginBottom: 64 }}>
          <div style={{ color: '#C8922A', fontSize: 11, fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 12 }}>
            The System
          </div>
          <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 'clamp(32px, 5vw, 52px)', fontWeight: 400, margin: 0 }}>
            How It Works
          </h2>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 32 }}>
          {HOW_IT_WORKS.map((step, i) => (
            <div key={i} className={`fade-in delay-${i + 1}`} style={{
              ...
              background: '#0D1929', border: '1px solid #1E3550', borderRadius: 16,
            }}>
              <div style={{
                fontSize: 64, fontWeight: 700, color: 'rgba(200,146,42,0.08)',
                fontFamily: 'Georgia, serif', lineHeight: 1, marginBottom: 16,
              }}>{step.step}</div>
              <div style={{ color: '#C8922A', fontSize: 11, fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 8 }}>
                Step {step.step}
              </div>
              <div style={{ color: '#F4F0E8', fontSize: 18, fontWeight: 600, marginBottom: 12, fontFamily: 'Georgia, serif' }}>
                {step.title}
              </div>
              ...
              {i < HOW_IT_WORKS.length - 1 && (
                <div style={{
                  ...
                  color: '#1E3550', fontSize: 20, display: 'none',
                }}>→</div>
              )}
            </div>
          ))}
      ...
      <section id="features" style={{ padding: '80px 40px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
          {FEATURES.map((f, i) => (
            <div key={i} className={`fade-in feature-card delay-${(i % 3) + 1}`} style={{
              padding: '28px 24px',
              background: '#0D1929', border: '1px solid #1E3550', borderRadius: 14,
      ...
      <section style={{ padding: '80px 40px', background: '#0D1929', borderTop: '1px solid #1E3550', borderBottom: '1px solid #1E3550' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          <div className="fade-in" style={{ textAlign: 'center', marginBottom: 48 }}>
            <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 400, margin: 0 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
            {TESTIMONIALS.map((t, i) => (
              <div key={i} className={`fade-in delay-${i + 1}`} style={{
                background: '#08101E', border: '1px solid #1E3550', borderRadius: 14, padding: '28px 24px',
              }}>
      ...
      <section id="pricing" style={{ padding: '100px 40px', maxWidth: 900, margin: '0 auto' }}>
        <div className="fade-in" style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 'clamp(32px, 5vw, 52px)', fontWeight: 400, margin: '0 0 16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24, alignItems: 'start' }}>
          ...
          <div className="fade-in delay-1" style={{
            background: '#0D1929', border: '1px solid #1E3550', borderRadius: 16, padding: '36px 32px',
          }}>
            ...
            <button
              ...
              style={{
                ...
                background: 'transparent', border: '1px solid #1E3550',
                color: '#7A91B0', padding: '12px', borderRadius: 10,
          ...
          <div className="fade-in delay-2" style={{
            background: '#0D1929',
            border: '2px solid #C8922A', borderRadius: 16, padding: '36px 32px',
            position: 'relative',
          }}>
            <div style={{
              ...
              padding: '4px 16px', borderRadius: 20, letterSpacing: '0.1em', textTransform: 'uppercase',
            }}>Most Popular</div>
      ...
      <section className="fade-in" style={{
        ...
        <h2 style={{
          ...
          fontWeight: 400, margin: '0 auto 20px', maxWidth: 600,
        }}>
        ...
        <div style={{ color: '#3A5070', fontSize: 12, marginTop: 16 }}>
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ color: '#7A91B0', fontSize: 13 }}>© 2026 Simply Success</span>
        </div>
        <div style={{ display: 'flex', gap: 24 }}>
          {['Privacy Policy', 'Terms of Service', 'Contact'].map(l => (
            <a key={l} href="#" className="nav-link"
              style={{ color: '#3A5070', fontSize: 12, textDecoration: 'none' }}>
              {l}
            </a>
          ))}
        </div>
